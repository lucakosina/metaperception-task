export const ssms = [
  {
    ...
    rows: [
      ...
      {
        value: "SSMS_9",
        text: "Does a passing thought ever seem so real it frightens you?",
      },
      {
        value: "SSMS_10",
        text:
      ...
      {
        value: "SSMS_12",
        text: "Does your sense of smell sometimes become unusually strong?",
      },
      {
        value: "SSMS_13",
        text: "Are you easily confused if too much happens at the same time?",
      },
      {
        value: "SSMS_14",
      ...
      {
        value: "SSMS_18",
        text: "Do you often have difficulties in controlling your thoughts?",
      },
      {
        value: "SSMS_19",
        text: "Are you easily distracted from work by daydreams?",
      },
      {
        value: "SSMS_20",
        text:
      ...
      {
        value: "SSMS_21",
        text: "Are you easily distracted when you read or talk to someone?",
      },
      {
        value: "SSMS_22",
        text: "Is it hard for you to make decisions?",
      },
      {
        value: "SSMS_23",
        text:
      ...
      {
        value: "SSMS_24",
        text: "Are there very few things that you have ever enjoyed doing?",
      },
      {
        value: "SSMS_25",
        text: "Are you much too independent to get involved with other people?",
      },
      {
        value: "SSMS_26",
      ...
      {
        value: "SSMS_28",
        text: "Do you feel very close to your friends?",
      },
      {
        value: "SSMS_29",
        text: "Has dancing or the idea of it always seemed dull to you?",
      },
      {
        value: "SSMS_30",
        text: "Do you like mixing with people?",
      },
      {
        value: "SSMS_31",
        text: "Is trying new foods something you have always enjoyed?",
      },
      {
        value: "SSMS_32",
      ...
      {
        value: "SSMS_35",
        text: "Would you like other people to be afraid of you?",
      },
      {
        value: "SSMS_36",
        text:
      ...
      {
        value: "SSMS_39",
        text: "Do you stop to think things over before doing anything?",
      },
      {
        value: "SSMS_40",
        text: "Do you often overindulge in alcohol or food?",
      },
